...
def menu(level, next: bool):
    ...
    font = pygame.font.Font('data/fonts/bonsergo.otf', 250)
    transp = pygame.Surface((WIDTH, HEIGHT))
    transp.fill(DARK_BLUE)
    transp.set_alpha(5)

    arkanoid_text = font.render('ARKANOID', False, DARK_BLUE)
    while display:
        screen.blit(load_png('menu.png'), (0, 0))
        screen.blit(arkanoid_text, (180, 140))
